<?php
  ...
  if (!empty($_POST['firstName']) && !empty($_POST['lastName']) && !empty($_POST['email']) && !empty($_POST['confirm_email'])
     && !empty($_POST['password']) && !empty($_POST['confirm_password']) && !empty($_POST['gender']) && !empty($_POST['address'])
     && !empty($_POST['city']) && !empty($_POST['zipCode']) && !empty($_POST['country']) && !empty($_POST['languages'])) {
    echo "Completed !";
  }
...
?>
    ...
    <div class="container-fluid background-texture">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="header-page">Registration</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <form class="form-horizontal" method="post" action="">
          <fieldset>
            <!-- Form Name -->
            <h4 class="page-header">Create account quicly !</h4>
            <p class="help-block"><?php echo flash(); ?></p>

            <!-- First name-->
            <div class="form-group">
              <label class="col-md-4 control-label" for="firstName">Fisrt name</label>  
              <div class="col-md-5">
            ...
            <!-- Confirm Email -->
            <div class="form-group">
              <label class="col-md-4 control-label" for="confirm_email">Confirm Email</label>
              <div class="col-md-5">
                <input id="confirm_email" name="confirm_email" type="email" placeholder="Re-type email" class="form-control input-md" required="">
              </div>
            </div>
            <!-- Password -->
            <div class="form-group">
            ...
            <!-- Select Multiple -->
            <div class="form-group">
              <label class="col-md-4 control-label" for="languages">Languages Spoken</label>
              <div class="col-md-5">
                  ...
                  <input type="checkbox" name="languages" value="Others"> Others<br>
                </select>
              </div>
            </div>
